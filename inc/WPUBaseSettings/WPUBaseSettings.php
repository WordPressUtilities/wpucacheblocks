...
/*
    ...
    $this->settings_details = array(
        ...
        'sections' => array(
            'import' => array(
                'name' => __('Import Settings', 'wpucacheblocks')
            )
        )
    );
    $this->settings = array(
        'sources' => array(
            'label' => __('Sources', 'wpucacheblocks'),
            'help' => __('One #hashtag or one @user per line.', 'wpucacheblocks'),
            'type' => 'textarea'
        )
    );
    if (is_admin()) {
        ...
        if(isset($_GET['page']) && $_GET['page'] == 'wpucacheblocks'){
